...
@Component({
  ...
  standalone: true,
  imports: [NgIf, NgClass, FormsModule, ReactiveFormsModule, DecimalPipe],
...
export class MyAccountComponent {
  ...
  showRolling = false;
  constructor(private backendService: BackendService, private toaster: ToastrService, private route: ActivatedRoute) {
