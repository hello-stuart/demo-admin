...
@Component({
  selector: 'app-lucky-7-a',
  standalone: true,
  imports: [NgFor, NgIf, NgClass, ShortNumberPipe, VideoPlayerComponent, ResultbarComponent],
  templateUrl: './lucky-7-a.component.html',
  styleUrl: './lucky-7-a.component.css'
})
export class Lucky7AComponent {
  ...
  constructor(
    ...
    // console.log(this.eventid, 'this.eventid this.eventid')
    this._roomId = '';
