...
@Component({
  selector: 'app-amar-akbar-anthony',
  standalone: true,
  imports: [VideoPlayerComponent, NgClass, NgFor, NgIf, ShortNumberPipe, ResultbarComponent],
  templateUrl: './amar-akbar-anthony.component.html',
  styleUrl: './amar-akbar-anthony.component.css'
})
export class AmarAkbarAnthonyComponent {
