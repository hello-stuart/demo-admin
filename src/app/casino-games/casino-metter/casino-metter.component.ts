...
@Component({
  selector: 'app-casino-metter',
  standalone: true,
  imports: [VideoPlayerComponent, NgIf, NgFor, ShortNumberPipe, ResultbarComponent],
  templateUrl: './casino-metter.component.html',
  styleUrl: './casino-metter.component.css'
})
export class CasinoMetterComponent implements OnInit, OnDestroy {
