...
@Component({
  selector: 'app-dragon-tiger-oneday',
  standalone: true,
  imports: [VideoPlayerComponent, NgFor, NgIf, NgClass, ShortNumberPipe, ResultbarComponent],
  templateUrl: './dragon-tiger-oneday.component.html',
  styleUrl: './dragon-tiger-oneday.component.css'
})
export class DragonTigerOnedayComponent {
